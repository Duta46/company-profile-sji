...
<head>
    ...
    <title>@yield('title') | {{ $setting->name ?? config('app.name', 'Sahabat Jepang Indonesia') }}</title>
...
<body data-kt-name="KITAPTN" id="kt_app_body" data-kt-app-layout="dark-sidebar" data-kt-app-header-fixed="true" data-kt-app-sidebar-enabled="true" data-kt-app-sidebar-fixed="true" data-kt-app-sidebar-hoverable="true"
